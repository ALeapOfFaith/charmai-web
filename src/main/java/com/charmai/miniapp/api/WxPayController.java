...
import com.charmai.miniapp.entity.NotifyDataDto;
...
public class WxPayController {
    ...
    public R<WxPayOrderQueryV3Result> queryOrder(@RequestParam(required = false) String transactionId,
        ...
        return R.ok(wxPayOrderQueryV3Result);
    }

    @PostMapping("/queryOrder")
    public WxPayOrderQueryV3Result queryOrder(@RequestBody WxPayOrderQueryV3Request wxPayOrderQueryRequest) throws WxPayException {
        return wxService.queryOrderV3(wxPayOrderQueryRequest);
    }
    ...
    public String parseOrderNotifyResult(@RequestBody String notifyData, HttpServletRequest request) throws WxPayException {
        log.info("receive weixin notify order");
        // 获取通知签名
        ...
        return myWxPayService.parseOrderNotifyResult(notifyData, signatureHeader);
    }

    @PostMapping("/mixCreateOrder")
    public R<WxPayUnifiedOrderV3Result.JsapiResult> mixCreateOrder() throws WxPayException {
        String user_id = ThirdSessionHolder.getThirdSession().getWxUserId();
        WxPayUnifiedOrderV3Result.JsapiResult jsapiResult = myWxPayService.mixCreateOrder(user_id);
