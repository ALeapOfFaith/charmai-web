package com.charmai.weixin.interceptor;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		if(StrUtil.isNotBlank(thirdSessionHeader)){
			...
			if(thirdSessionObj == null) {//session过期
				R r = R.fail(MyReturnCode.ERR_60001.getCode(), MyReturnCode.ERR_60001.getMsg());
			...
			R r = R.fail(MyReturnCode.ERR_60002.getCode(), MyReturnCode.ERR_60002.getMsg());
			this.writerPrint(response, r);
			return Boolean.FALSE;
		}
		return Boolean.TRUE;
